        ...
        children: [
            ...
            child: StreamBuilder<List<double>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasError) {
                  return const Center(child: Text("Lỗi tải biểu đồ lượng khách", style: TextStyle(color: Colors.red)));
                }
                if (!snapshot.hasData) {
          ...
          const Row(
            ...
            children: [
              ...
              Text("Đang cập nhật", // Thay đổi từ fix cứng
                  style: TextStyle(
          ...
          const Row(
            ...
            children: [
              Text("T.gian trung bình",
                  style: TextStyle(color: Colors.grey, fontSize: 14)),
              Text("-- phút", style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
        ],
      ),
